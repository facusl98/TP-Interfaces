      ...
      <div class="register-container">
        ...
        <form class ="register-form" "id="register-form" method="POST">
          ...
          <custom-button
            ...
            width="250px"
            height="50px"
            icon="/TP-Interfaces/TP4/assets/icons/common/SignUp.svg"
            iconSize="30px"
          ...
          <div class="signUp-with">
            <custom-button
              ...
              width="250px"
              height="50px"
              icon="/TP-Interfaces/TP4/assets/icons/socials/GoogleOriginal.svg"
              iconSize="30px"
              class="default"
            ...
            <custom-button
              ...
              width="250px"
              height="50px"
              icon="/TP-Interfaces/TP4/assets/icons/socials/FacebookOriginal.svg"
              iconSize="30px"
              class="default"
              funcName="register-with"
            ></custom-button>

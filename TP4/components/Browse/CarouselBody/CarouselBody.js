...
class CarouselBody extends BaseComponent {
  constructor() {
    ...
    this._types = {
      featured: {
        icon: "/TP-Interfaces/TP4/assets/icons/common/Featured.svg",
        text: "Featured Picks",
        import: () => gameService.getRandom(10)
      },
      trending: {
        icon: "/TP-Interfaces/TP4/assets/icons/common/Trending.svg",
        text: "Trending Games",
        import: () => gameService.getTrending()
      },
      recent: {
        icon: "/TP-Interfaces/TP4/assets/icons/common/New.svg",
        text: "Newly Added",
        import: () => gameService.getNewest()
      }, 
      platformers: {
        icon: "/TP-Interfaces/TP4/assets/icons/genres/Platformer.svg",
        text: "Platformer",
        import: () => gameService.getRandom(10)
      },
      arcade: {
        icon: "/TP-Interfaces/TP4/assets/icons/genres/Arcade.svg",
        text: "Arcade",
        import: () => gameService.getRandom(10)
      }, 
      rpg: {
        icon: "/TP-Interfaces/TP4/assets/icons/genres/RPG.svg",
        text: "RPG",
        import: () => gameService.getRandom(10)
      }, 
      puzzle: {
      ...
      fighting: {
        icon: "/TP-Interfaces/TP4/assets/icons/genres/Fighting.svg",
        text: "Fighting",
        import: () => gameService.getRandom(10)
      }
    };

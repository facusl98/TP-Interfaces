...
class CommentItem extends BaseComponent {
  ...
  async render() {
    ...
    <div class="user">
      <span class="user-name"><img src="/TP-Interfaces/TP4/assets/images/UserIcon.png" alt="User Pic" /> ${this._user}</span> 
    ...
    ${this._comments.length > 0 ? `
      <p class="toggle-responses">
        ${this._open ? `
          <custom-icon
            icon="/TP-Interfaces/TP4/assets/icons/common/ArrowUp.svg"
            size="20px"
          ></custom-icon>
          <span>Hide Responses</span>
        ` : `
          <custom-icon
            icon="/TP-Interfaces/TP4/assets/icons/common/ArrowDown.svg"
            size="20px"
          ></custom-icon>

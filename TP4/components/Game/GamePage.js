...
class GamePage extends BaseComponent {
  constructor() {
    ...
    this._games = {
      ...
      "blocka": {
        ...
        video: "/TP-Interfaces/TP4/assets/images/blocka/blocka-vid.png",
        img1: "/TP-Interfaces/TP4/assets/images/blocka/blocka-1.png",
        img2: "/TP-Interfaces/TP4/assets/images/blocka/blocka-2.png",
  ...
  async render() {
    ...
    <div class="game-cont">
      <div class="breadcrumb-container">
        <div class="image-bread-container">
          <a href="#/browse" class="breadcrumb">
            <custom-icon icon="/TP-Interfaces/TP4/assets/icons/common/Home.svg" size = "15px"></custom-icon>
      ...
      <div class="game-area-container">
        ...
        <div class="game-area hidden" id="play">
          <custom-button
          icon="/TP-Interfaces/TP4/assets/icons/common/Play.svg"
          width="120px"
          height="70px"
          class="default"
          iconSize="30px"
      ...
      <div class="game-bar">
        ...
        <div class="game-bar-buttons">
          <custom-button
          icon="/TP-Interfaces/TP4/assets/icons/common/Share.svg"
          width="65px"
          height="45px"
          class="default"
          >
          ...
          <custom-button
          icon="/TP-Interfaces/TP4/assets/icons/common/FavoriteEmpty.svg"
          width="65px"
          height="45px"
          class="default"
          >
          ...
          <custom-button
          icon="/TP-Interfaces/TP4/assets/icons/common/Maximize.svg"
          width="65px"
          height="45px"
          class="default"
          >
    ...
    <div class="ad ad-1">
      <img class="ad-image" src="/TP-Interfaces/TP4/assets/images/ad.png" alt="Ad Image"></img>
    </div>
    ...
    <div class="game-content">
      <div class="left-column">
        ...
        <div class="ad ad-2">
          <img class="ad-image" src="/TP-Interfaces/TP4/assets/images/ad2.png" alt="Ad Image"></img>          
        </div>

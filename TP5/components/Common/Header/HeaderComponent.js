...
class HeaderComponent extends BaseComponent {
    ...
    this.shadowRoot.innerHTML += `
      ...
      <div class="header-rows">
        <div class="logo-container">
          ...
          "/TP-Interfaces/TP5/assets/icons/common/Menu.svg" :
          "/TP-Interfaces/TP5/assets/icons/common/Close.svg"}" class="burger-btn"/>
          
          <a href="#/browse">
            <img class="logo" src="/TP-Interfaces/TP5/assets/images/Logo.png" alt="StimGames Logo">
          </a> 
        ...
        <div class="search-container" id="search-container">
            <div class="search-input">
              ...
              <custom-icon icon="/TP-Interfaces/TP5/assets/icons/common/Search.svg" size="20px" style="dark"></custom-icon>
            </div>
        </div>
        <img src="/TP-Interfaces/TP5/assets/images/UserIcon.png" class="menu-btn">
      </div>
      ${this._burger ? (() => {
        ...
        html += visibleGenres.map((genre) => `
          <a href="#search">
            <custom-button
              icon="/TP-Interfaces/TP5/assets/icons/genres/${genre}.svg"
              iconSize="20px"
              text="${genre}"
  ...
  _setupMenu() {
    ...
    this._menu.innerHTML = `
      <div class="cont">
        <div class="user">
          <img src="/TP-Interfaces/TP5/assets/images/UserIcon.png" alt="User Icon" />
          <p>Random_User12</p>
        </div>
        <div class="links-cont">
          <div class="top">
            <a href="#/browse">
              <custom-icon icon="/TP-Interfaces/TP5/assets/icons/common/Home.svg" size="24px">
              </custom-icon>
              <span>Browse</span>
            </a>
            <a href="#/search">
              <custom-icon icon="/TP-Interfaces/TP5/assets/icons/common/Search.svg" size="24px">
              </custom-icon>
              <span>Search</span>
            </a>
            <a href="#profile">
              <custom-icon icon="/TP-Interfaces/TP5/assets/icons/common/Profile.svg" size="24px">
              </custom-icon>
              <span>Profile</span>
            </a>
            <a href="#favorites">
              <custom-icon icon="/TP-Interfaces/TP5/assets/icons/common/FavoriteEmpty.svg" size="24px">
              </custom-icon>
              <span>Favorites</span>
            </a>
          </div>
          ...
          <div class="bottom">
            <a href="#/login">
              <custom-icon icon="/TP-Interfaces/TP5/assets/icons/common/Logout.svg" size="24px">
              </custom-icon>
              <span>Logout</span>
            </a>
          </div>          
  ...
  _showSuggestions() {
    ...
    <a href="#/search">
    <custom-icon icon="/TP-Interfaces/TP5/assets/icons/common/Filter.svg" size="15px" style="dark"></custom-icon>
    Advanced Search</a>
    </div>
    `;

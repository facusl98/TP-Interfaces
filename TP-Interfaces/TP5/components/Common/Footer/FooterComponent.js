...
class FooterComponent extends BaseComponent { 
  constructor() {
    ...
    this._facebook = "/TP-Interfaces/TP5/assets/icons/socials/Facebook.svg";
    this._instagram = "/TP-Interfaces/TP5/assets/icons/socials/Instagram.svg";
    this._linkedin = "/TP-Interfaces/TP5/assets/icons/socials/Linkedin.svg";
    this._twitter = "/TP-Interfaces/TP5/assets/icons/socials/Twitter.svg";
    this._youtube = "/TP-Interfaces/TP5/assets/icons/socials/Youtube.svg";
    this._peg = "/TP-Interfaces/TP5/assets/images/PegSolitaire.png";
    this.mail = "/TP-Interfaces/TP5/assets/icons/common/Gmail.svg";
    ...
    this.shadowRoot.innerHTML += `
        ...
        <div class ="footer-containers-rows">
            ...
            <div class ="column-center-left invisible">
                ...
                <div class="list">
                    <a href="#/browse">
                    <custom-icon icon="/TP-Interfaces/TP5/assets/icons/common/Home.svg" size="20px"></custom-icon>
                    Catalog
                    </a>
                    <a href="#/search">
                    <custom-icon icon="/TP-Interfaces/TP5/assets/icons/common/Search.svg" size="20px"></custom-icon>
                    About Us</a>
                    <a href="#/browse">
                    <custom-icon icon="/TP-Interfaces/TP5/assets/icons/common/Profile.svg" size="20px"></custom-icon>
                    Profile</a>
                    <a href="#/browse">
                    <custom-icon icon="/TP-Interfaces/TP5/assets/icons/common/FavoriteEmpty.svg" size="20px"></custom-icon>
                    Favorites</a>
                    <a href="#/browse">
                    <custom-icon icon="/TP-Interfaces/TP5/assets/icons/common/Faq.svg" size="20px"></custom-icon>
                    FAQs</a>
            ...
            <div class="column-center-right invisible">
                ...
                <div class="popular-genres list">
                    <a href="#/browse">
                    <custom-icon icon="/TP-Interfaces/TP5/assets/icons/genres/Platformer.svg" size="20px"></custom-icon>
                    Platformers
                    </a>
                    <a href="#/browse">
                    <custom-icon icon="/TP-Interfaces/TP5/assets/icons/genres/Arcade.svg" size="20px"></custom-icon>
                    Arcade
                    </a>
                    <a href="#/browse">
                    <custom-icon icon="/TP-Interfaces/TP5/assets/icons/genres/RPG.svg" size="20px"></custom-icon>
                    RPG
                    </a>
                    <a href="#/browse">
                    <custom-icon icon="/TP-Interfaces/TP5/assets/icons/genres/Puzzle.svg" size="20px"></custom-icon>
                    Puzzle
                    </a>
                    <a href="#/browse">
                    <custom-icon icon="/TP-Interfaces/TP5/assets/icons/genres/Fighting.svg" size="20px"></custom-icon>
                    Fighting
                    </a>
                </div>
            ...
            <div class="column-right invisible">
                ...
                <div class ="ubication">
                    ...
                    <custom-icon icon="/TP-Interfaces/TP5/assets/icons/common/Ubication.svg" size = "20px"></custom-icon>
                    Unicen exactas</a>
                    <img class="ubiImg" src="/TP-Interfaces/TP5/assets/images/Maps.png" alt="Gooogle Maps Location">
                </div>
                <h2>Legal</h2>
        ...
        <div class="us">
                ...
                <img src="/TP-Interfaces/TP5/assets/images/Logo.png" alt="Logo" class="invisible">
        </div>
